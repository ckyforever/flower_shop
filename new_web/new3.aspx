<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="new3.aspx.cs" Inherits="cky_flower.new_web.new3" %>
...
<!-- //menu -->
		<div class="container">
			<div class="banner1">
				<div class="logo">
					<a href="new1.aspx">企业招聘新闻<span>我们等你！</span></a>
				</div
				</div>
			</div>
		</div>
                        ...
                        <div class=news-grid-left">
                            ...
                            <div class="col-xs-8 news-date-left" style="width:200px;height:200px">
                                ...
                                <p>
                                   说的啥呢？</p>
                                <div class="read">
                                    <a class="hvr-shutter-out-horizontal" href='<%# "information.aspx?newsId=" + Eval("id") +"&id=3"%>'>了解更多</a>
                                </div>
                            </div>
                            <div class="clearfix">
                            </div>
