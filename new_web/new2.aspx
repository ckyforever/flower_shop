<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="new2.aspx.cs" Inherits="cky_flower.new_web.new2" %>
...
<!-- //menu -->
		<div class="container">
			<div class="banner1">
				<div class="logo">
					<a href="new2.aspx">行业新闻<span></span></a>
				</div>
				</div>
			</div>
		</div>
                        ...
                        <div class=news-grid-left">
                            ...
                            <div class="col-xs-8 news-date-left" style="width:200px;height:200px">
                                ...
                                <p>
                                   说的啥呢？</p>
                                <div class="read">
                                    <a class="hvr-shutter-out-horizontal" href='<%# "information.aspx?newsId=" + Eval("id")+"&id=2" %>'>了解更多</a>
                                </div>
                            </div>
                            <div class="clearfix">
                            </div>
	...
	<div class="footer">
		<div class="container">
			<div class="footer-left">
				<p>Copyright &copy; 刘小蝶别墅有限公司 <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网站模板" target="_blank">可爱的员工们</a></p>
			</div>
