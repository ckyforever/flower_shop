<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news1.aspx.cs" Inherits="cky_flower.back_web.news1" %>
    ...
    <div class="" id="home">
      <nav class="navbar navbar-expand-xl">
        <div class="container h-100">
          <a class="navbar-brand" href="news1.aspx">
            <h1 class="tm-site-title mb-0">企业新闻</h1>
          </a>
          <button
