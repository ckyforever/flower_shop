...
namespace cky_flower.back_web
{
    public partial class news1 : System.Web.UI.Page
    {
        ...
        protected void read_Click1(object sender, EventArgs e)
        {
            ...
            string strsql = "select * from 陈凯宇_news1";
        ...
        {
            datamysql me = new datamysql();
            string strsql = "insert into 陈凯宇_news1(Id,类别,标题,内容,时间) values('" + ID.Text + "'";
        ...
        {
            datamysql me = new datamysql();
            string strsql = "update 陈凯宇_news1 set  ";
        ...
        {
            datamysql me = new datamysql();
            string strsql = "delete from 陈凯宇_news1  where Id='" + ID.Text + "'";
            me.ExecuteSql(strsql);
            read_Click1(sender, e);
        }
    }
