<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news3.aspx.cs" Inherits="cky_flower.back_web.news3" %>
    ...
    <div class="" id="home">
      <nav class="navbar navbar-expand-xl">
        <div class="container h-100">
          <a class="navbar-brand" href="news3.aspx">
            <h1 class="tm-site-title mb-0">企业招聘新闻</h1>
          </a>
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto h-100">
              ...
              <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="news1.aspx" id="navbarDropdown" role="button" data-toggle="dropdown"
