<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="cky_flower.back_web.product" %>
...
<form id="form1" runat="server">
      ...
      <div class="container h-100">
        <a class="navbar-brand" href="product.aspx">
          <h1 class="tm-site-title mb-0">产品订购</h1>
        </a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto h-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="product.aspx">
                  ...
                  <tr>
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="GridView1_RowCommand1">
                          <Columns>
                              ...
                              <asp:BoundField DataField="消费者" HeaderText="消费者" />
            ...
            <div class="tm-product-table-container">
              <table class="table tm-table-small tm-product-table">
                <tbody>
                    ...
                    <br />
                  <tr>
                      <asp:Label ID="Label3" runat="server" Text="消费者 " Width="20%"></asp:Label><asp:TextBox ID="消费者" runat="server"></asp:TextBox><br />
                  </tr>
                    <br />
                    <br />
                  <tr>
                      <asp:Label ID="Label4" runat="server" Text="购买数量" Width="20%"></asp:Label><asp:TextBox ID="购买数量" runat="server"></asp:TextBox><br />
                  </tr>
                    <br />
                    <br />
                  <tr>
                      <asp:Label ID="Label5" runat="server" Text="产品名称" Width="20%"></asp:Label><asp:TextBox ID="产品名称" runat="server"></asp:TextBox><br />
                  </tr>
                    <br />
                    <br />
                  <tr>
                      <asp:Label ID="Label6" runat="server" Text="购买时间" Width="20%"></asp:Label><asp:TextBox ID="购买时间" runat="server"></asp:TextBox><br />
                  </tr>
                    <br />
                    <br />
                   <td>
    ...
    <footer class="tm-footer row tm-mt-small" style="float:left;margin:50px 0 0 450px">
      <div class="col-12 font-weight-light">
        <p class="text-center text-white mb-0 px-4 small">
          Copyright &copy; 陈凯宇flower有限公司管理系统
            </p>        
        </div>
    </footer>
    </form>
