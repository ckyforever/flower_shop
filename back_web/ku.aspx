<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ku.aspx.cs" Inherits="cky_flower.back_web.ku" %>
...
<form id="form1" runat="server">
     <nav class="navbar navbar-expand-xl">
      <div class="container h-100">
        <a class="navbar-brand" href="ku.aspx">
          <h1 class="tm-site-title mb-0">产品信息</h1>
        </a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto h-100">
                        ...
                        <li class="nav-item">
              <a class="nav-link active" href="ku.aspx">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link d-block" href="login.aspx">
               <b>
                   亲亲宝贝<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>你终于来了，快点看看有没有卖出去</b>
              </a>
            </li>
          </ul>
        </div>
                  ...
                  <tr>
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="GridView1_RowCommand1">
                          <Columns>
                              ...
                              <asp:BoundField DataField="产品名" HeaderText="产品名" />
                              <asp:BoundField DataField="价格" HeaderText="价格" />
                              <asp:BoundField DataField="产品介绍" HeaderText="产品介绍" />
            ...
            <div class="tm-product-table-container">
              <table class="table tm-table-small tm-product-table">
                <tbody>
                    ...
                    <br />
                  <tr>
                      <asp:Label ID="Label3" runat="server" Text="产品名称 " Width="20%"></asp:Label><asp:TextBox ID="产品名称" runat="server"></asp:TextBox><br />
                  </tr>
                    <br />
                    <br />
                  <tr>
                      <asp:Label ID="Label4" runat="server" Text="价格" Width="20%"></asp:Label><asp:TextBox ID="价格" runat="server"></asp:TextBox><br />
                  </tr>
                    <br />
                    <br />
                  <tr>
                      <asp:Label ID="Label5" runat="server" Text="产品介绍" Width="20%"></asp:Label><asp:TextBox ID="产品介绍" runat="server"></asp:TextBox><br />
                  </tr>
                    <br />
                    <br />
                  <tr>
                      <asp:Label ID="Label6" runat="server" Text="数量" Width="20%"></asp:Label><asp:TextBox ID="数量" runat="server"></asp:TextBox><br />
                  </tr>
                    <br />
                    <asp:Label ID="Label7" runat="server" Text="图片" Width="20%"></asp:Label><asp:TextBox ID="图片" runat="server"></asp:TextBox><br />
                    <asp:FileUpload ID="FileUpload1" runat="server" />
                    <asp:Button ID="Button_upload" runat="server" Text="上传" OnClick="Button_upload_Click" />
                    <br />
                   <td>
