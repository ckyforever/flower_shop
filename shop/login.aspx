<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="cky_flower.shop.login" %>
    ...
    <div class="container clearfix">
      <div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
        <div class="col-lg-6 col-md-6 col-sm-12">
          ...
          <p>优质房源等你来采购！</p>
          <p class="withpadding">还没有注册吗？<a href="add.aspx">点击</a>开始注册！.</p>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12">
          <h4 class="title">
                    	<span>登录</span>
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                  <asp:Label ID="i" runat="server" Text="密码"></asp:Label>
