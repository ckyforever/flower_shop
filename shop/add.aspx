<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="cky_flower.shop.add" %>
    ...
    <div class="container clearfix">
      <div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
        <div class="col-lg-6 col-md-6 col-sm-12">
          ...
          <p>优质房源等你来采购！</p>
          <p class="withpadding">欢迎光临！<a href="add.aspx">快快快</a>开始注册！.</p>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12">
          <h4 class="title">
                    	<span>注册</span>
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                  <asp:Label ID="label" runat="server" Text="用户名"></asp:Label>
              ...
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                  <asp:Label ID="i" runat="server" Text="地址"></asp:Label>
                  <asp:TextBox ID="address" runat="server"></asp:TextBox>
              </div>
                     <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                  <asp:Label ID="Label1" runat="server" Text="联系方式"></asp:Label>
            ...
            <!--div class="form-group">
              <div class="checkbox">
                ...
                <asp:Button ID="btn_login" runat="server" Text="注册" OnClick="btn_login_Click" />
        </div>
        <!-- end login -->
      </div>
      <!-- end content -->
